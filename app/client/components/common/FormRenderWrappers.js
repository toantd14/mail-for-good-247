...
export const renderSettingsDropdownList = ({
  input,
  label,
  type,
  ...
  <div style={{ marginBottom: "1em" }}>
    <label>
      {label} - {exists ? savedLabel : notSavedLabel}
    </label>
...
export const renderSettingsField = ({
  input,
  label,
  type,
  meta: { touched, error, warning },
...
export const renderEditorTypeRadio = ({ input, label, type, meta: { touched, error, warning } }) => (
  <div>
    ...
    <div className="form-group">
      <label>
        <Field component="input" type="radio" name={input.name} value="Plaintext" /> Plaintext
      </label>
      <br />
      <label>
        <Field component="input" type="radio" name={input.name} value="HTML" /> HTML
      </label>
      <br />
      {touched &&
        ((error && (
...
export const renderTextEditor = ({
  ...
  <div>
    ...
    <div>
      <Field
        name={emailBody ? emailBody : "emailBody"}
        value={() => input.value}

...
import { notify, consume } from "../actions/notificationActions";
...
describe("(Reducer/Action Creator) notification", () => {
  ...
  it("should handle RECEIVE_NOTIFICATION", () => {
    ...
    expect(notifications(undefined, notify(mockNotification))).to.deep.equal({
  ...
  it("should handle RECEIVE_NOTIFICATION", () => {
    expect(notifications(undefined, consume())).to.deep.equal({
      ...initialState.notifications,

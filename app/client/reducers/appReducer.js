...
export function profile(state = initialState.profile, action) {
  switch (action.type) {
    case REQUEST_WS_PROFILE: {
      return {
        ...state, // Does nothing for now, as this is a websocket this can probably be removed later
      };
    }

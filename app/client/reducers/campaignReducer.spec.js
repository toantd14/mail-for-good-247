...
describe("(Reducer/Action Creator) campaign", () => {
  ...
  it("should handle REQUEST_POST_CREATECAMPAIGN", () => {
    expect(createCampaign(undefined, requestPostCreateCampaign())).to.deep.equal({
  ...
  it("should handle COMPLETE_POST_CREATECAMPAIGN", () => {
    expect(createCampaign(undefined, completePostCreateCampaign())).to.deep.equal({
      ...initialState.createCampaign,
      isPosting: false,
    });
  });
  ...
  it("should handle REQUEST_POST_CREATETEMPLATE", () => {
    expect(createTemplate(undefined, requestPostCreateTemplate())).to.deep.equal({
  ...
  it("should handle COMPLETE_POST_CREATETEMPLATE", () => {
    expect(createTemplate(undefined, completePostCreateTemplate())).to.deep.equal({
      ...initialState.createTemplate,
      isPosting: false,
    });
  });
  ...
  it("should handle REQUEST_GET_CAMPAIGNS", () => {
    expect(manageCampaign(undefined, requestGetCampaign())).to.deep.equal({
  ...
  it("should handle COMPLETE_GET_CAMPAIGNS", () => {
    ...
    expect(manageCampaign(undefined, completeGetCampaign(mockCampaigns))).to.deep.equal({
      ...initialState.manageCampaign,
  ...
  it("should handle COMPLETE_DELETE_CAMPAIGNS", () => {
    const mockCampaigns = "something";
    expect(manageCampaign(undefined, completeDeleteCampaigns(mockCampaigns))).to.deep.equal({
      ...initialState.manageCampaign,
      campaigns: mockCampaigns,
    });
  });
  ...
  it("should handle REQUEST_GET_TEMPLATES", () => {
    expect(manageTemplates(undefined, requestGetTemplates())).to.deep.equal({
  ...
  it("should handle COMPLETE_GET_TEMPLATES", () => {
    ...
    expect(manageTemplates(undefined, completeGetTemplates(mockTemplates))).to.deep.equal({
      ...initialState.manageTemplates,
  ...
  it("should handle COMPLETE_DELETE_TEMPLATES", () => {
    const mockTemplates = "something";
    expect(manageTemplates(undefined, completeDeleteTemplates(mockTemplates))).to.deep.equal({
      ...initialState.manageTemplates,
      templates: mockTemplates,
    });
  });
  ...
  it("should handle REQUEST_POST_SENDCAMPAIGN", () => {
    expect(sendCampaign(undefined, requestPostSendCampaign())).to.deep.equal({
  ...
  it("should handle REQUEST_POST_SENDTESTEMAIL", () => {
    expect(sendTest(undefined, requestPostSendTestEmail())).to.deep.equal({

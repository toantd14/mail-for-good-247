...
export class TemplateViewComponent extends Component {
  ...
  componentWillReceiveProps(props) {
    ...
    if (props.templates && props.templates.length && !this.props.templates.length) {
  ...
  render() {
    const { thisTemplate, showTestSendModal, testEmail } = this.state;

    const { isPostingSendTest, isGetting } = this.props;
        ...
        <section className="content">
          <div className="box box-primary">
            ...
            <div className="box-body">
              <PreviewTemplateForm
                templateView={this.state.thisTemplate}
                form={this.props.form}
                lastPage={this.lastPage}
                handleSubmit={this.handleSubmit}
                openTestSendModal={this.openTestSendModal}
                submitting={this.props.isPosting}
              />

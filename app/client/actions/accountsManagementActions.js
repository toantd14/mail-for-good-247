import {
  REQUEST_POST_CREATE_NEW_USER,
  COMPLETE_POST_CREATE_NEW_USER,
  REQUEST_DELETE_USER,
  COMPLETE_DELETE_USER,
} from "../constants/actionTypes";
import { API_CREATE_USER_ENDPOINT, API_DELETE_USER_ENDPOINT } from "../constants/endpoints";
...
export function deleteUser(userData) {
  return (dispatch) => {
    ...
    axios
      .delete(API_DELETE_USER_ENDPOINT, {
        data: userData,
      })
      .then((response) => {

 ...
 */
  ...
  Object.keys(settingsToChange).forEach((key) => {
    if (settingsToChange[key]) {
      // Implicity check field is not empty
  ...
  if (
    selectProvidedFields.amazonSimpleEmailServiceAccessKey ||
    selectProvidedFields.amazonSimpleEmailServiceSecretKey ||
    selectProvidedFields.region ||
    selectProvidedFields.email
  ) {

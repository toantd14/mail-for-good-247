...
function mapStateToProps(state) {
  ...
  const activePermissionsEmails = state.activePermissions.activePermissions.map((x) => ({
    ...x,
    email: x.fromUserEmail,
  }));
...
export class AppComponent extends Component {
  ...
  pushToDashboardOrRefresh() {
    ...
    if (this.props.location.pathname === "/") this.context.router.replace("/");
    ...
    return (
      <div className="wrapper">
        ...
        <RightSidebar
          ...
          changeAccountToSelf={this.changeAccountToSelf}
          changeAccount={this.changeAccount}
          isGettingActivePermissions={isGettingActivePermissions}
          activePermissionsEmails={activePermissionsEmails}
        />

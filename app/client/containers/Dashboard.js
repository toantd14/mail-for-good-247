...
export class DashboardComponent extends Component {
  render() {
    const totalSentCount = this.props.campaigns.reduce(
      (total, campaign) => total + campaign["campaignanalytic.totalSentCount"],
      0
    );
    ...
    return (
      <div>
        <section className="content-header">
          <h1>
            Dashboard <small>An overview of your lists and campaigns</small>
          </h1>
        </section>

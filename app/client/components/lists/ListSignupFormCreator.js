      ...
      <Modal show={this.state.showModal} onHide={this.closeModal.bind(this)}>
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <br />
            <p>
              Optionally, you can customize where the user is redirected on success and failure by inserting a URL in
              the value of the redirectOnSuccess and redirectOnFailure.
            </p>
            <br />
          ...
          <div className="modal-footer">
            <CopyToClipboard
              text={formBody}
              onCopy={() => {
                this.props.notify({ message: "Copied to clipboard", colour: "green" }).bind(this);
              }}
            >

...
export class ReceivedPermissionsComponent extends Component {
  ...
  render() {
    const {
      isGettingReceivedPermissionOffers,
        ...
        <section className="content">
          <div className="box box-primary">
            ...
            <div className="box-body">
              <ManageReceivedPermissionOffersTable
                data={receivedPermissionOffers}
                rejectRows={this.deleteReceivedPermissionOfferRows}
                acceptRows={this.acceptReceivedPermissionOfferRows}
              />
            </div>
          ...
          <div className="box box-primary">
            ...
            <div className="box-body">
              <ManageActivePermissionsTable
                data={activePermissions}
                deletePermissionRows={this.deleteActivePermissionRows}
              />
            </div>

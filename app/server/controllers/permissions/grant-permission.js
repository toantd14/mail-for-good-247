...
module.exports = function (req, res) {
  ...
  function authUser() {
    User.findById(req.user.id).then((userInstance) => {
      if (userInstance) {
        generator.next(userInstance);
        return null;
      }
    ...
    ACL.findOne({
      ...
      if (aclInstance) {
        ...
        res
          ...
          .send({
            message:
              "You have already granted this user permissions. If you wish to change them, please delete them first",
          });
    ...
    OfferPermission.findOne({
      ...
      if (opInstance) {
        res
          ...
          .send({
            message:
              "You have already offered this user permissions. If you wish to change them, please delete them first",
          });

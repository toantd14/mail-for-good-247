...
const CampaignReportsTable = (props) => {
  ...
  const options = {
    ...
    onRowClick: () => {
      // This fires on clicking a row. TODO: Needs to go to another route with the format /:[campaign-name-slug] where users can manage (edit, send, schedule, delete) the campaign
  ...
  return (
    ...
    >
      ...
      <TableHeaderColumn dataAlign="center" width="300">
        Tags (WIP)
      </TableHeaderColumn>
      <TableHeaderColumn
        dataField="createdAt"

  ...
  resetFormAndSubmit(e) {
    ...
    if (valid) {
      const formattedFormValues = {
        // Format values in alignment with server expectations
    ...
    return (
      <div>
        <section className="content-header">
          <h1>
            Settings <small>Settings page</small>
          </h1>
        </section>
                ...
                <form onSubmit={this.resetFormAndSubmit}>
                  <div className="box-body">
                    <Field
                      ...
                      helpText={
                        <div>
                          <a target="_blank" href="https://aws.amazon.com/developers/access-keys/">
                            Find out more about access keys
                          </a>
                        </div>
                      }
                    />
                    <Field
                      ...
                      helpText={
                        <div>
                          <a target="_blank" href="https://aws.amazon.com/developers/access-keys/">
                            Find out more about secret access keys
                          </a>
                        </div>
                      }
                    />
                    <Field
                      ...
                      helpText={
                        <div>
                          Configure your SES email address{" "}
                          <a target="_blank" href="https://aws.amazon.com/developers/access-keys/">
                            here.
                          </a>
                          This is almost always your sending/from email address.
                        </div>
                      }
                    />
                    <Field
                      ...
                      helpText={
                        <div>
                          View your limits for{" "}
                          <a
                            target="_blank"
                            href="https://us-west-2.console.aws.amazon.com/ses/home?region=us-west-2#dashboard:"
                          >
                            us-west-2
                          </a>
                          ,{" "}
                          <a
                            target="_blank"
                            href="https://us-east-1.console.aws.amazon.com/ses/home?region=us-east-1#dashboard:"
                          >
                            us-east-1
                          </a>
                          , or{" "}
                          <a
                            target="_blank"
                            href="https://eu-west-1.console.aws.amazon.com/ses/home?region=eu-west-1#dashboard:"
                          >
                            eu-west-1
                          </a>
                        </div>
                    ...
                    <Field
                      ...
                      helpText={
                        <div>
                          Display a custom URL for unsubscription and clickthrough tracking links by providing a white
                          label URL (without the trailing backslash). This must be configured beforehand with your DNS
                          hosting service.
                        </div>
                      }
                    />

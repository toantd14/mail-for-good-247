...
export class OfferedPermissionsComponent extends Component {
  ...
  render() {
    const {
      isGettingGrantedPermissions,
      grantedPermissions,
      isGettingGrantOfferedPermissions,
        ...
        <section className="content">
          <div className="box box-primary">
            ...
            <div className="box-body">
              <ManageGrantedPermissionsTable
                data={grantedPermissions}
                deletePermissionRows={this.deleteGrantedPermissionRows}
              />
            </div>
          ...
          <div className="box box-primary">
            ...
            <div className="box-body">
              <ManageGrantOfferedPermissionsTable
                data={grantOfferedPermissions}
                deletePermissionRows={this.deleteGrantOfferedPermissionRows}
              />
            </div>

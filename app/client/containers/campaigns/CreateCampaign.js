...
export class CreateCampaignComponent extends Component {
  ...
  render() {
    ...
    const type =
      this.props.form && this.props.form.values.type ? this.props.form.values.type : this.state.initialFormValues.type;
        ...
        <section className="content">
          <div className="box box-primary">
            <div className="box-body">
              ...
              {page === 2 && (
                <PreviewCampaignForm form={form} lastPage={this.lastPage} handleSubmit={this.handleSubmit} />
              )}
            </div>

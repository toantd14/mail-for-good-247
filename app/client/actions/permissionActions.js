...
export function deleteGrantedPermissions(offerIds, grantedPermissions) {
  return (dispatch) => {
    ...
    axios
      .delete(API_GRANT_PERMISSIONS_ENDPOINT, {
        data: { offerIds },
      })
      .then((response) => {
...
export function deleteActivePermissions(offerIds, activePermissions) {
  return (dispatch) => {
    ...
    axios
      .delete(API_ACTIVE_PERMISSIONS_ENDPOINT, {
        data: { offerIds },
      })
      .then((response) => {
        dispatch(notify({ message: response.data.message, colour: "green" }));
...
export function postAcceptReceivedOffers(offerIds, receivedOffers) {
  return (dispatch) => {
    ...
    axios
      .post(API_RECEIVED_PERMISSIONS_ENDPOINT, {
        data: { offerIds },
      })
      .then((response) => {
        dispatch(notify({ message: response.data.message, colour: "green" }));
...
export function deleteRejectReceivedOffers(offerIds, receivedOffers) {
  return (dispatch) => {
    ...
    axios
      .delete(API_RECEIVED_PERMISSIONS_ENDPOINT, {
        data: { offerIds },
      })
      .then((response) => {
        dispatch(notify({ message: response.data.message, colour: "green" }));
...
export function deleteGrantOfferedPermissions(offerIds, grantOfferedPermisions) {
  return (dispatch) => {
    ...
    axios
      .delete(API_GRANT_OFFERED_PERMISSIONS_ENDPOINT, {
        data: { offerIds },
      })
      .then((response) => {
        dispatch(notify({ message: response.data.message, colour: "green" }));
